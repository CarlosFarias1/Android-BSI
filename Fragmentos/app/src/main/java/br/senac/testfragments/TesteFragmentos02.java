 ...
 */
public class TesteFragmentos02 extends Fragment {
    private Button btnMensagem;


    public TesteFragmentos02() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_teste_fragmentos02, container, false);
